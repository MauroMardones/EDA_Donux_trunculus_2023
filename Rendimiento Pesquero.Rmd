...
```{r}
Dens2014pob <- read_excel(here("Data", 
                            "Datos_13_14", 
                            "Datos tallas 2014_2015",
                            "Datos totales",
                            "ABUNDANCIAS_Com_2014_2015_Paco.xlsx"))

Dens2014com <- read_excel(here("Data", 
                            "Datos_13_14", 
                            "Datos tallas 2014_2015",
                            "Datos totales",
                            "ABUNDANCIAS_Pobl_2014-2015.xlsx",
                            sheet = "Ratro a pie_resumido"))
...
rend1720 <- ggplot(denscom1720tot, 
               aes(MES,Rend1,
                group=mariscador,
                color=mariscador))+
    geom_point(alpha=.7) +
...
comp <- ggplot(denscomtot %>% 
                 filter(Sampling.point == c(2,4,6, "M")),
               aes(ANO,Rend1))+
    geom_point(alpha=.7) +
    geom_smooth(method= "lm",
                level=0.5,
