...
tabla_proporciones <- sizeallfil %>%
  select(Beach, Sampling.point, sizeE, rastro, ANO) %>% 
  group_by(ANO, Sampling.point, rastro, Beach) %>%
  mutate(total_size = sum(sizeE, na.rm = TRUE),
         proportion = sizeE / total_size) 
