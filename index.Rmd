...
These data, spetially length frecuencies, must be weighted to the sampling estimates, because they are just a subsample. This approach has a logic used like Figure 1;
...
```{r}
data <- here("EDA_Donux_trunculus_2023")
```
# LENGTH FRECUENCY DB
