...
De todas formas, hay una columna que difiere de ambos bases filtradas, en este caso `CMSWsub` definida previamente. por lo mismo, no puedo juntar las bases.


Ahora calculamos las siguientes variables ;
