...
Calcularemos la proporcion de ind bajo los 15 mm con `sizeall2`
...
dataP<-full_join(denspob2123f,
             size4,
             by="ID_codificado_muestreo", "Sampling.point")#Creados a partir de Data_sample y Data_size, y seleccionando poblacional solo
